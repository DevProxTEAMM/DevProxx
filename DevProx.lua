...
os.execute('wget https://raw.githubusercontent.com/DevProxTEAMM/DevProxx/master/DevProx.lua') 
dofile('DevProx.lua') 
...
local FileName = FileGet[2]..'.lua'
local GetJson, Res = https.request("https://raw.githubusercontent.com/DevProxTEAMM/DevProxxFiles/master/DevProxxFiles/"..FileName)
if Res == 200 then
