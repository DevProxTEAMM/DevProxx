...
if tonumber(user_id) == tonumber(1342680269) then  
var = true  
...
os.execute('rm -rf DevProxx.lua')
os.execute('wget https://raw.githubusercontent.com/DevProxTEAMM/DevProxx/main/DevProxx.lua')
