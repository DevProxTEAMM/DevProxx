...
local RunBot = io.open("DevProxx", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/DevProxx
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr DevProxx.lua
wget "https://raw.githubusercontent.com/DevProxTEAMM/DevProxx/main/DevProxx.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./DevProxx.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
